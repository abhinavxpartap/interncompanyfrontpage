...
const CaseStudy = () => {
  return (
    <div>
      <div className="w-[90%]  relative md:px-[100px] pt-[84px] pb-[38px]  overflow-hidden mx-auto">
      ...
      <div className='w-full h-full overflow-x-scroll scrollbar scroll whitespace-nowrap scroll-smooth flex flex-row  mx-auto' >
        {caseStudies.map((caseStudy, index: number) => (
          <div key={index} className=" max-w-[320px] md:max-w-[711px] md:h-[366px] bg-white  rounded-[20px] boxshad flex flex-row justify-between p-[10px] md:px-[23px] md:py-[20px] m-4">
