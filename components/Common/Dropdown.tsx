...
export const Dropdown: FC<DropdownInterface> = (props) => {
    ...
    const arrow = !["/", "/home", "/aboutus","/portfolio","service","/partner","/industries", "/faq", "", "/contact", "/ourStory", "/term"].includes(
        router.pathname
    )
        ? "/images/arrow.svg"
        : !isSticky
            ...
            : "/images/arrow.svg";
    const color = !["", "", "/faq","","/portfolio","/blog","","/service", "",  "/term"].includes(
        router.pathname
    )
        ? "text-[white]"
        : isSticky
            ? "text-[white]"
            : "text-black";
    const arrowBlack = !["/", "/home", "/partner","/aboutus","/portfolio","/service","/industries", "/faq", "/contact", "", "/ourStory"].includes(router.pathname)
    || !isSticky
        ? "/images/arrow.svg"
        : "/images/arrow.svg";
    const colorBlack = !["/", "/home","/blog", "/partner","/aboutus","/portfolio", "/faq","/service", "/contact",  "","/ourStory"].includes(
        router.pathname
    )
        ? "text-[#000000]"
        : isSticky
