...
export const Dropdown: FC<DropdownInterface> = (props) => {
    ...
    const arrow = !["/", "/home", "/partner", "/faq", "/blog", "/contact", "/ourStory", "/term"].includes(
        router.pathname
    )
        ? "/images/arrow.svg"
        : !isSticky
            ...
            : "/images/arrow.svg";
    const color = !["/", "/home", "/faq", "/contact",  "/term"].includes(
        router.pathname
    )
        ? "text-[white]"
        : isSticky
            ? "text-[white]"
            : "text-white";
    const arrowBlack = !["/", "/home", "/partner", "/faq", "/contact", "/blog", "/ourStory"].includes(router.pathname)
    || !isSticky
        ? "/images/arrow.svg"
        : "/images/arrow.svg";
    const colorBlack = !["/", "/home", "/partner", "/faq", "/contact",  "/blog","/ourStory"].includes(
        router.pathname
    )
        ? "text-[#000000]"
        : isSticky
