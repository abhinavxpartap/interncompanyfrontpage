...
export const Dropdown: FC<DropdownInterface> = (props) => {
    ...
    const arrow = !["/", "/home", "/aboutus","/partner", "/faq", "/blog", "/contact", "/ourStory", "/term"].includes(
        router.pathname
    )
        ? "/images/arrow.svg"
        : !isSticky
            ...
            : "/images/arrow.svg";
    const color = !["/", "/home", "/faq","/aboutus", "/contact",  "/term"].includes(
        router.pathname
    )
        ? "text-[white]"
        : isSticky
            ? "text-[white]"
            : "text-white";
    const arrowBlack = !["/", "/home", "/partner","/aboutus", "/faq", "/contact", "/blog", "/ourStory"].includes(router.pathname)
    || !isSticky
        ? "/images/arrow.svg"
        : "/images/arrow.svg";
    const colorBlack = !["/", "/home", "/partner","/aboutus", "/faq", "/contact",  "/blog","/ourStory"].includes(
        router.pathname
    )
        ? "text-[#000000]"
        : isSticky
