...
export const Header: React.FC<any> = () => {
  ...
  const logo = !["/portfolio", "/partner", "/faq","/blog", "/ourStory", "/term"].includes(
      router.pathname
  )
      ? data.logo_light
      : isSticky
          ? data.logo_light
          : data.logo_dark;
  const buttonType = (!["/", "/home","/aboutus","/service","/portfolio","/industries", "/", "/faq", "/contact", "/landing", "/getStarted", "/ourStory"].includes(
      router.pathname
