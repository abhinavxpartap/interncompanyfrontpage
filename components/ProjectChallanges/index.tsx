            ...
            <div className="flex md:flex-row mt-[30px] sm:ml-[80px] sm:gap-[60px] flex-col ">
              <div className="flex flex-row">
                ...
                <div className="flex flex-col ml-[5px]">
                  <div className="text-[18px] font-medium">Design</div>
                  <div className="max-w-[450px] text-[#757B8A] text-[15px]">
                    With large data sets in the form of multiple food menus and
                    extensive user base in various countries, achieving quick
                    screen transition was a challenge. Our team with its
                    immaculate planning and use of the right tools ensured a
                    much quicker Pizza Hut delivery app screen transition
                  </div>
                </div>
              </div>
              ...
              <div className="flex md:mt-0 mt-[25px] flex-row">
                ...
                <div className="flex  flex-col ml-[5px]">
                  ...
                  <div className="max-w-[480px]  text-[#757B8A] text-[15px]">
                    At the starting of the project, there were different
                    operational issues due to product management. Our team
                    keenly studied all the issues across the layers and the
                    legacy system, and resolved the challenge by taking
                    appropriate actions at the right
                  </div>
                </div>
              </div>
            </div>
