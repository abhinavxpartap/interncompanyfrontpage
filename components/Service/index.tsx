...
const services = [
  {
    ...
    description:
      'layered dolor sit amet, consectetur adipisicing elit. Facere, nobis, id expedita dolores officiis laboriosam.',
  },
  {
  ...
  return (
    <div className="md:px-[100px] relative flex flex-col items-center py-[40px] pt-[80px] text-center max-w-[1377.5px] overflow-hidden h-auto mx-auto">
      ...
      <div className="text-[#151448] md:text-[40px] text-[24px]  font-bold leading-[125%] mt-[13px] max-w-[481px]">
        Zuca provides all kinds of services you need
      </div>
        ...
        {services.map((service, index: number) => {
          return (
            ...
            >
              ...
              <h1 className="text-[20px] lg:text-[15px] xl:text-[20px] pt-[15px] font-semibold text-[#042552]">
                {service.title}
              </h1>
