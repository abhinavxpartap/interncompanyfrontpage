...
export const Services = (props: any) => {
    ...
    return <div className="bg-[#F5F9FF] md:pt-[98px] pt-[90px]">
        <div className="max-w-[721px] mx-auto text-center mb-[97px] sm:px-0 px-[20px]">
            ...
            <div
                className=" xl:text-[19px] text-[14px] leading-[30px] tracking-[-0.26px] text-[#101D2C] font-medium">
                {description}
            </div>
        </div>
        <div className="">
                            ...
                            >
                                ...
                                <div>
                                    <div className="flex items-center">
                                        <div
                                            className="md:text-[25px] text-[15px] leading-[25px] tracking-[-0.6px]">
                                            {service.title}
                                        </div>
                                        <Img
                                            src="/images/plus.svg"
                                    ...
                                    <div className="service-card-details">
                                        <div
                                            className="md:mt-[20px] mt-[5px] xxl:text-[19px] md:text-[19px] text-[12px] leading-[30px] tracking-[-0.46px] font-normal">
                                            {service.description}
                                        </div>
                                        <Img
