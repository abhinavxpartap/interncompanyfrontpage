    ...
    return (
        <div>
            ...
            <div className="w-full h-full overflow-x-scroll scrollbar scroll whitespace-nowrap scroll-smooth flex flex-row max-w-[1377.5px] mx-auto">
                {SuccessStory.SuccessStory.map((SuccessStory:CaseStudyInterface, index:number) => (
                    <div
                        key={index}
                    ...
                    >
                        ...
                        <div className='flex flex-col w-[350px] whitespace-break-spaces ml-[15px] md:ml-[30px]'>
                            ...
                            <div className="text-[#177DF0] text-[14px] leading-[20px] md:text-[20px] font-bold md:leading-[37.4px] mt-[10px]">{SuccessStory.org}</div>
                            <div className="text-[#747C85] text-[12px] leading-[18px] md:text-[16px] mt-[5px] font-medium md:leading-[26px]">{SuccessStory.description}</div>
                            <div>
                                <MUIMaterial.Button
