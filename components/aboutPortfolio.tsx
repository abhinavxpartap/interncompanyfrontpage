            ...
            <div className="w-[92%]  px-[20px] pt-[10px] pb-[20px] mx-auto flex flex-col bg-white rounded-[15px] boxshad">
                <div className="flex md:flex-row md:gap-[80px] flex-col">
                    <div className="max-w-[650px]">
                        ...
                        <p className="text-[15px] mt-[8px] text-[#757B8A] font-normal">{subtitle}</p>
                        <p className="text-[15px] mt-[8px] leading-[25px] text-[#757B8A] font-normal">{content}</p>
                    </div>
                    <div className="mt-[50px]">
                        ...
                        <div className="text-[16px] mt-[15px] font-medium text-[#757B8A]">Services</div>
