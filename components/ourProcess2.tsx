...
export const OurProcess2: React.FC<any> = (props) => {
        ...
        <div className="max-w-[1377.5px] pt-[15px] pb-[40px] relative mx-auto">
            ...
            <div className="flex md:flex-row flex-col  gap-[90px]">
                ...
                {processSteps.map((step) => (
                    <div className="flex md:justify-normal justify-center items-center flex-row" key={step.number}>
    ...
    return (
        <div style={{ background: "#FFFFFF" }} className="bg-cover bg-center bg-no-repeat relative block">
            {content}
        </div>
    );
};
