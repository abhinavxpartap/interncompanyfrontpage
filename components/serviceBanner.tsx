    ...
    export const ServiceBanner: React.FC<any> = (props) => {
        ...
        const content = <>
            ...
            >
                ...
                <p
                    className="font-medium pt-[5px] md:pt-[15px] mx-auto md:mx-0 w-[90%] text-center md:text-start md:w-[450px] text-[14px] sm:text-[14px] md:text-[16px] lg:text-[18px] text-white lg:w-[550px]">
                    {subtitle}
                </p>
