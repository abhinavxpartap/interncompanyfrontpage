    ...
    export const ServiceBanner: React.FC<any> = (props) => {
        ...
        const content = <>
            ...
            >
                ...
                <p
                    className="font-medium pt-[5px] md:pt-[15px] mx-auto md:mx-0 w-[99%] text-center md:text-start md:w-[450px] text-[16px] sm:text-[16px] md:text-[16px] lg:text-[18px] text-white lg:w-[550px]">
                    {subtitle}
                </p>
                <div className="flex pt-[10px] md:pt-[20px] pt-[18px] justify-center items-center md:justify-start">
                    <Button
