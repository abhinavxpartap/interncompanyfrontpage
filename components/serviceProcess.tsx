    ...
    const content = <>
        ...
        >
            <div className="w-[100%] mx-auto flex flex-col text-center items-center justify-center ">
                 <h1 className="text-[#333333] font-bold text-[18px] sm:text-[20px] md:text-[25px] lg:text-[30px]">{title}</h1>
                <p className="text-[#333333] font-medium w-[320px]  text-[14px] sm:text-[12px] md:text-[12px] lg:text-[14px] sm:w-[400px] md:w-[450px] pt-[10px] ">{subtitle}</p>
