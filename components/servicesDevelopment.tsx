    ...
    const content = <>
        ...
        >
            <div className="w-[100%] flex flex-col text-center items-center justify-center ">
                <h1 className="text-[#151448] font-bold text-[19px] leading-[25px] sm:text-[20px] sm:leading-[30px] md:text-[30px] md:leading-[40px] w-[300px] sm:w-[350px] md:w-[500px] ">{title}</h1>
                <p className="text-[#333333] font-normal w-[90%] text-[13px] sm:text-[12px] md:text-[14px] pt-[10px] ">{subtitle}</p>
