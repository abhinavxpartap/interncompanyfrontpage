    ...
    <>
      <div className="max-w-[1377.5px] mx-auto flex items-center justify-between md:pt-[80px]  pt-[30px] pb-[30px] md:pb-[80px]">
        <div className="w-[100%] flex flex-col text-center items-center justify-center ">
          ...
          >
            <div className="w-[100%]  md:w-[18vw] pl-[10px] md:pl-[15px] py-[25px] lg:py-[40px] xl:py-[50px] flex flex-col gap-[15px] lg:gap-[18px] xl:gap-[25px] justify-start bg-[#E0E1FF] rounded-t-[10px]  md:rounded-l-[10px] ">
              {leftData && leftData.length>0 && ( leftData.map((item , index: number) => (
                <div className="flex flex-row  gap-[10px] items-center" key={index}>
                  <Img
                    ...
                    alt={item.title}
                  />
                  <h1 className="lg:text-[13px]  xl:text-[14px] font-normal text-[4B5A69] cursor-pointer active:text-[#177DF0] hover:text-[#177DF0]">
                    {item.title}
                  </h1>
                </div>
              )))}
            ...
            <div className="w-[100%] md:w-[20vw] pl-[10px] md:pl-[15px] py-[25px] lg:py-[40px] xl:py-[50px] flex flex-col gap-[15px] lg:gap-[18px] xl:gap-[25px] justify-start bg-[#E0E1FF] rounded-b-[10px] md:rounded-r-[10px] ">
              {rightData && rightData.length>0 && ( rightData.map((item, index: number) => (
                  <div className="flex flex-row gap-[10px] items-center" key={index}>
                    <Img
                        src={item.image}
                        className="w-[25px] lg:w-[25px] xl:w-[30px]"
