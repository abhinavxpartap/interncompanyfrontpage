...
import { eventApi } from "../../../../helper/event";
...
const Edit: React.FC<BlogEditFormInterface> = (props) => {
    ...
    const save = async () => {
        ...
        try {
            ...
            const response = await fetch("/api/Event/PUT/events", {
                method: "PUT",
                headers: {
    ...
    return <PrivateLayout title="Alumel Admin - Event">
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const data: any = await eventApi.getSingleEvent(slug);
    console.log(data)
    return {
        props: {
            blog: null,
