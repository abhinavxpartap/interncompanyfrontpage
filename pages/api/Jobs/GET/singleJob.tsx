...
const getBlogBySlug = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
        ...
        const collection = db.collection('jobs'); // Replace 'YourCollectionName' with your collection name
        const data = await collection.findOne({ id: slug }); // Find a single document by slug
