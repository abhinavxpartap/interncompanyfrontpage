...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const { _id, JourneyBanner , JourneyData1, JourneyData2 } = req.body;
        if (!_id || !JourneyBanner ||  !JourneyData1 || !JourneyData2 ) {
        ...
        const result = await collection.updateOne(
            { _id: objectId },
            { $set: { "data.NewJourney": JourneyBanner, "data.key_features":JourneyData1,"data.approach": JourneyData2 } }
        );
        client.close();
