...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const { _id, bannerData, caseStudies } = req.body;

        if (!_id || !bannerData || !caseStudies) {
        ...
        const collection = db.collection('caseStudy'); // Replace with your collection name
