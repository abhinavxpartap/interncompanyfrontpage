...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const { _id, bannerData, SuccessStory } = req.body;

        if (!_id || !bannerData || !SuccessStory) {
        ...
        const collection = db.collection('sucessStory'); // Replace with your collection name
