...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const { _id, DevelopmentBanner , DevelopmentHeaderLeft,DevelopmentHeaderRight } = req.body;
        if (!_id || !DevelopmentBanner|| !DevelopmentHeaderRight || !DevelopmentHeaderLeft) {
        ...
        const result = await collection.updateOne(
            { _id: objectId },
            { $set: { "data.DevelopmentBanner": DevelopmentBanner, "data.DevelopmentHeaderRight":DevelopmentHeaderRight, "data.DevelopmentHeaderLeft":DevelopmentHeaderLeft } }
        );
        client.close();
