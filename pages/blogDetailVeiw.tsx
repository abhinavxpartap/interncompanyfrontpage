...
const content = [
    {
        title:"Does a Medical Supplies Shipping Software need to Adhere to HIPAA Act?"
    },
    {
        title:"Exploring the HIPAA Compliant Medical Supplies Platform Cost"
    },
    {
      title:"Factors Affecting the HIPAA Compliant Medical Supplies Platform Cost"
    },
    {
    ...
    {
        title:"How to Reduce the Cost of Creating a HIPAA Compliant Mobile App for Medical Supplies Delivery?"
    },
    {
        title:"How Can Zuca Help You Develop a HIPAA-Compliant Medical Supplies Delivery Platform?"
    }
]
...
const blogContent = [
    ...
    },
    {
        ...
        description: "HIPAA-compliant software uses strong security features like locks, passwords, and records to keep patient information safe while it’s stored, moved, or delivered. This helps prevent hackers or unauthorized people from getting access to the information and keeps patient details private and secure."
    },
    {
        title:"Regulatory Compliance",
        description: "HIPAA rules say that healthcare organizations and their partners must follow certain rules to protect patient information. Developing a HIPAA-compliant medical supplies distribution platform that follows these rules shows that a business follows the law, which helps them avoid getting in trouble and damaging their reputation."
    },
    {
        title:"Build Trust and Reputation",
        description: "Using HIPAA-compliant software shows that you take patient privacy and data security seriously. This helps healthcare providers, patients, and other app users to trust your business and consider you a reliable and trustworthy healthcare partner."
    },
    {
        title:"Competitive Advantage",
        description: "In the healthcare industry, with strict rules, having shipping and logistics software that follows HIPAA regulations can make your business stand out from the competition. It shows that you understand the unique needs of healthcare providers and can provide them with secure and compliant transportation and logistics services."
    },
    {
        title:"Exploring the HIPAA Compliant Medical Supplies Platform Cost",
        description: "To give you a rough idea, the cost of developing a HIPAA-compliant medical supplies delivery platform can vary between $45,000 to $200,000. Further factors impact the overall development cost, including the complexity of the software, the hourly rate and location of the software development agency, the features to be implemented in the software, etc. Even though the total budget for app development may vary as per the type of software required and the services it should offer, it is necessary to get in touch with a dedicated healthcare software development company like Zuca that can offer you clear cost estimates by prioritizing the features based on your business requirements."
    },
    {
        title:"Competitive Advantage",
        description: "In the healthcare industry, with strict rules, having shipping and logistics software that follows HIPAA regulations can make your business stand out from the competition. It shows that you understand the unique needs of healthcare providers and can provide them with secure and compliant transportation and logistics services."
                ...
                <div className="w-[100%] max-w-[1377.5px] mx-auto flex flex-col items-center justify-center" style={{background:"#F9FBFF"}} >
                    <div className="w-[100%] flex flex-col items-center">
                        ...
                        <div className="w-[100%] px-[20px] md:px-[60px] flex flex-col gap-[10px] py-[60px]">
                            <p className="text-[#31D7A9] text-[15px] lg:text-[18px] font-medium">Healthcare & Fitness</p>
                            <h1 className="text-[#151448] text-[20px] lg:text-[22px] leading-[28px] lg:leading-[30px]  font-semibold">How much does it cost to build a HIPAA-Compliant platform for medical supplies delivery?</h1>
                            <p className="text-[#444444] lg:text-[14px] text-[12px] font-normal">Author Name  20 Jun 2023</p>
                        </div>
                    </div>
                    <div className="w-[100%] px-[20px] md:px-[60px] flex flex-col md:flex-row gap-[30px]">
                        <div className=" w-[90vw] md:w-[30vw] gap-[20px] flex flex-col">
                            <h1 className="text-[#444444] text-[24px] font-normal">Contents</h1>
                            ...
                            <div className="flex flex-row gap-[30px] pl-[5px] ">
                                ...
                                <Img key={index} src={item.icon} className="w-[24px] md:w-[20px] lg:w-[24px] cursor-pointer" alt={"SocialIcon"}/>
                                ))}
                            </div>
                            <p className="cursor-pointer text-[#444444] text-[14px] lg:text-[18px] font-normal">Share this Blog</p>
                        </div>
                        <div className="w-[90vw] md:w-[65vw] flex flex-col gap-[20px]">
                            ...
                            <div>
                                <Img src="/BlogdetailImage1.jpg" className="w-[100%]" alt={"BlogImage"}/>
                            </div>
