...
import pageData from "../../data/industry/Artificial Intelligence.json";
...
const ArtificialIntelligancePage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Artificial_Intelligence.title}</title>
                <meta name="description" content={seoData.Artificial_Intelligence.description}/>
                <meta name="keywords" content={seoData.Artificial_Intelligence.keywords}/>
                <meta name="title" content={seoData.Artificial_Intelligence.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
...
export default ArtificialIntelligancePage;
