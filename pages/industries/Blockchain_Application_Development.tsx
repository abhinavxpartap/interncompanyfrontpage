...
const BlockChainpage: React.FC = () => {
    ...
    useEffect(() => {
        setIsLoading(true);
        fetch("/api/industries/GET/blockChainAppliactionDevelopment")
    ...
    return (<>
            <Head>
                ...
                <meta name="description" content={seoData.Blockchain_Application_Development.description}/>
                <meta name="keywords" content={seoData.Blockchain_Application_Development.keywords}/>
                <meta name="title" content={seoData.Blockchain_Application_Development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
