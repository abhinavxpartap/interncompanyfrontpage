...
import pageData from "../../data/industries/IoT Development.json";
...
const IoTpage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.IoT_Development.title}</title>
                <meta name="description" content={seoData.IoT_Development.description}/>
                <meta name="keywords" content={seoData.IoT_Development.keywords}/>
                <meta name="title" content={seoData.IoT_Development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
