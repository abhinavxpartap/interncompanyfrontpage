...
import pageData from "../../data/industries/Machine Learning.json";
...
const MachineLearningpage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Machine_Learning.title}</title>
                <meta name="description" content={seoData.Machine_Learning.description}/>
                <meta name="keywords" content={seoData.Machine_Learning.keywords}/>
                <meta name="title" content={seoData.Machine_Learning.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
