...
import pageData from "../../data/industry/Robot Process Automation.json";
...
const RobotProcessAutomationPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Robot_Process.title}</title>
                <meta name="description" content={seoData.Robot_Process.description}/>
                <meta name="keywords" content={seoData.Robot_Process.keywords}/>
                <meta name="title" content={seoData.Robot_Process.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
...
export default RobotProcessAutomationPage;
