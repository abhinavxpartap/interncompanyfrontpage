...
import pageData from "../../data/service/Android Application Development.json";
...
const AndroidApplicationPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Android_Application_Development.title}</title>
                <meta name="description" content={seoData.Android_Application_Development.description}/>
                <meta name="keywords" content={seoData.Android_Application_Development.keywords}/>
                <meta name="title" content={seoData.Android_Application_Development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
