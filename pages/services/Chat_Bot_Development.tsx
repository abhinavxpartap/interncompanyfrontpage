...
import pageData from "../../data/service/Chat Bot Development.json";
...
const ChatBotPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Chat_Bot_Development.title}</title>
                <meta name="description" content={seoData.Chat_Bot_Development.description}/>
                <meta name="keywords" content={seoData.Chat_Bot_Development.keywords}/>
                <meta name="title" content={seoData.Chat_Bot_Development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
