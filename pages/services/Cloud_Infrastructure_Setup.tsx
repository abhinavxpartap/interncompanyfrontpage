...
import pageData from "../../data/service/Cloud Infrastructure Setup.json";
...
const CloudInfrastructurePage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Cloud_Infrastructure_Setup.title}</title>
                <meta name="description" content={seoData.Cloud_Infrastructure_Setup.description}/>
                <meta name="keywords" content={seoData.Cloud_Infrastructure_Setup.keywords}/>
                <meta name="title" content={seoData.Cloud_Infrastructure_Setup.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
