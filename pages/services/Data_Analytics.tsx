...
import pageData from "../../data/service/Data Analystics.json";
...
const DataAnalyticsPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Data_Analytics.title}</title>
                <meta name="description" content={seoData.Data_Analytics.description}/>
                <meta name="keywords" content={seoData.Data_Analytics.keywords}/>
                <meta name="title" content={seoData.Data_Analytics.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
