...
import pageData from "../../data/service/IOS Application Development.json";
...
const IOSApplicationPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.IOS_Application_development.title}</title>
                <meta name="description" content={seoData.IOS_Application_development.description}/>
                <meta name="keywords" content={seoData.IOS_Application_development.keywords}/>
                <meta name="title" content={seoData.IOS_Application_development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
...
export default IOSApplicationPage;
