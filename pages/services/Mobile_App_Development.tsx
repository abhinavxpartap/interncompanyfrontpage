...
import pageData from "../../data/service/Mobile App Development.json";
...
const MobileAppPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Mobile_App_Development.title}</title>
                <meta name="description" content={seoData.Mobile_App_Development.description}/>
                <meta name="keywords" content={seoData.Mobile_App_Development.keywords}/>
                <meta name="title" content={seoData.Mobile_App_Development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
