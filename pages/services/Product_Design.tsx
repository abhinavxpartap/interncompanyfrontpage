...
import pageData from "../../data/service/Product Design.json";
...
const ProductDesignPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Product_Design.title}</title>
                <meta name="description" content={seoData.Product_Design.description}/>
                <meta name="keywords" content={seoData.Product_Design.keywords}/>
                <meta name="title" content={seoData.Product_Design.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
