...
import pageData from "../../data/service/UX_UI Consulting.json";
...
const UxUiPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.UX_UI_Consulting.title}</title>
                <meta name="description" content={seoData.UX_UI_Consulting.description}/>
                <meta name="keywords" content={seoData.UX_UI_Consulting.keywords}/>
                <meta name="title" content={seoData.UX_UI_Consulting.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
