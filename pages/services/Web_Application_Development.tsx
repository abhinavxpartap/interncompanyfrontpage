...
import pageData from "../../data/service/Web Application Development.json";
...
const WebApplicationPage: React.FC = () => {
    return (<>
            <Head>
                <title>{seoData.Web_Application_Development.title}</title>
                <meta name="description" content={seoData.Web_Application_Development.description}/>
                <meta name="keywords" content={seoData.Web_Application_Development.keywords}/>
                <meta name="title" content={seoData.Web_Application_Development.metaTitle}/>
            </Head>
            <div className="main">
                <ServiceBanner
